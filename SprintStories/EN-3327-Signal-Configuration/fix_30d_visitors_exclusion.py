...
from src.paths import (
    FIX_VISITORS_EXCLUSION_30D_DATA_DIR,
    FIX_VISITORS_EXCLUSION_30D_LOGS_DIR as LOGS_DIR,
    SCRIPT_DIR,
...
PLAN_OUTPUT_PATH = FIX_VISITORS_EXCLUSION_30D_DATA_DIR / "fix_30d_visitors_exclusion_plan.json"


def default_log_path() -> Path:
    stamp = datetime.now(timezone.utc).strftime("%Y%m%d_%H%M%S")
    LOGS_DIR.mkdir(parents=True, exist_ok=True)
    return LOGS_DIR / f"fix_30d_visitors_exclusion_{stamp}.log"
